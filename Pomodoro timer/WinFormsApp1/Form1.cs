...
namespace WinFormsApp1 // Namespace des Projekts
{
    public partial class TimerBox : Form // Hauptklasse des Formulars
    {
        ...
        bool Isactive = true;
        SoundPlayer breaksound = new SoundPlayer(@"Resources\315694__acollier123__casio-1000p-preset-piano-c.wav"); // Pfad zum Sound f�r die Pause
        SoundPlayer worksound = new SoundPlayer(@"Resources\346956__alexlancemx__si_bemol_tone_2016.wav"); // Pfad zum Sound f�r die Arbeitszeit
